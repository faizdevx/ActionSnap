...
# ── CHANGED: import from transformer module instead of lstm ──────────────────
from src.transformer import ActionClassificationTransformer as ActionClassificationLSTM
...
def analyze(filename):
    return Response(
        analyse_video(pose_detector, lstm_classifier, filename),
